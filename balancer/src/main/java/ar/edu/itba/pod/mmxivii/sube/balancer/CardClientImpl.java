...
public class CardClientImpl extends UnicastRemoteObject implements CardClient {
	...
	public double recharge(@Nonnull UID id, @Nonnull String description,
		...
		return getCardService(id).recharge(id, description, amount);
	}
